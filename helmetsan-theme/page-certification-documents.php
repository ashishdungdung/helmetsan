<?php
/**
 * Certification documents hub page template.
 *
...
$query = new WP_Query([
    ...
    'meta_query' => [
        [
            'key' => 'certification_documents_json',
            'compare' => 'EXISTS',
        ],
    ],
]);
...
<section class="hs-section">
    <header class="hs-section__head">
        <h1><?php the_title(); ?></h1>
        <p>Helmets with linked certification references and documentation metadata.</p>
    </header>
    ...
    <?php else : ?>
        <p>No helmets with certification document metadata yet.</p>
    <?php endif; ?>
</section>
<?php
get_footer();

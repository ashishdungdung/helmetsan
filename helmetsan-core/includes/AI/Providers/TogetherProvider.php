...
final class TogetherProvider extends BaseProvider
{
    private const URL = 'https://api.together.xyz/v1/chat/completions';

    public function __construct(
        private readonly string $apiKey,
        private readonly string $model = 'meta-llama/Llama-3.2-3B-Instruct-Turbo'
    ) {
    }

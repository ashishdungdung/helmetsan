...
final class FireworksProvider extends BaseProvider
{
    private const URL = 'https://api.fireworks.ai/inference/v1/chat/completions';

    public function __construct(
        private readonly string $apiKey,
        private readonly string $model = 'accounts/fireworks/models/llama-v3p1-8b-instruct'
    ) {
    }
